...
gradesrowadd <- matrix(student04, byrow = TRUE, nrow = 1)
grades <- rbind(grades,gradesrowadd)
grades

## Add a new assignment column with `cbind()`
assignment04 <- c(92.1, 84.3, 75.1, 97.8)
gradescoladd <- matrix(assignment04, byrow = TRUE, nrow = 4)
grades <- cbind(grades, gradescoladd)
grades
